...
def evaluate(fixture: dict[str, Any]) -> dict[str, Any]:
    ...
    if authorization == "VALID" and not sufficient:
        reasons.add(E007)
    ...
    elif authorization == "VALID" and fixture["attack_class"] == "AUTHORITY_AS_PROOF":
...
def main() -> int:
    ...
    if failures:
        print("DIAGNOSTIC: IMPLEMENTATION_DEFECT or specification discrepancy; do not rewrite fixtures.")
        return 1
